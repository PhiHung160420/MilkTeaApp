...
const CustomTabbarBottom = ({containerStyle, isFloat, children, onPress}) => {
  if (isFloat) {
    return (
    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => (
            <CustomTabbarBottom {...props} containerStyle={{marginRight: 6}} />
          ),
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => (
            <CustomTabbarBottom {...props} containerStyle={{marginLeft: 6}} />
          ),
        }}
      />
      <Tab.Screen
